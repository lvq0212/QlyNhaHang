...
class Android extends MY_Controller {
   ...
   public function searchproduct()
    ...
    $contentsmsg="ID đơn hàng: ".$orderid." với số lượng:".number_format($gtotal,2);
    $contentstitle="Đơn hàng mới được đặt";
    $curl3 = curl_init();
...
curl_close($curl3);
       /*Push Notification*/
		return $this->respondWithSuccess('Đặt hàng thành công', $output);		
		 }
		} else {
		  return $this->respondWithError('Đơn hàng chưa được đặt!!!',$output);
		}
			}
