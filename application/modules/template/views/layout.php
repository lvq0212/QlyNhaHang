                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1><?php if($this->uri->segment(2)=="paymentmethod"){
									...
									$titlename="Bên thứ ba";
									}
								else if($this->uri->segment(2)=="country_city_list"){
									$titlename="Danh sách quốc gia";
									}
								else{
