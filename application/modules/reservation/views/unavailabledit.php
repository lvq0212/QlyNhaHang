                   	...
                   	<?php echo form_hidden('offdayid', (!empty($intinfo->offdayid)?$intinfo->offdayid:null)) ?>
                        ...
                        <div class="col-sm-8">
                            <select name="status"  class="form-control">
                                ...
                                <option value="1" <?php if(!empty($intinfo)){if($intinfo->is_active==1){echo "Selected";}} else{echo "Selected";} ?>>Hiệu lực</option>
                                <option value="0" <?php if(!empty($intinfo)){if($intinfo->is_active==0){echo "Selected";}} ?>>Vô hiệu</option>
                              </select>
                        </div>
                    </div>
