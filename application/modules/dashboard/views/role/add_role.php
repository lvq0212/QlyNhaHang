                    ...
                    <table class="table table-bordered table-hover" id="RoleTbl">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-info btn-sm" onclick="edit('<?php echo $value->role_id?>')" data-toggle="tooltip" data-placement="left" title="Cập nhật"  ><i class="fa fa-pencil" aria-hidden="true"></i></a>
