                        ...
                        <thead>
                            <tr>
                                ...
                                <th><div class="checkbox checkbox-success text-center">
                                        <input type="checkbox" class="allcheck" name="allcreate" value="1" id="allcreate_<?php echo $m?>" title="Thêm" usemap="<?php echo $m?>">
                                        <label for="allcreate_<?php echo $m?>"><strong><?php echo display('can_create') ?></strong></label>
                                    </div></th>
                                <th><div class="checkbox checkbox-success text-center">
                                        <input type="checkbox" class="allcheck" name="allread" value="1" id="allread_<?php echo $m?>" title="Đọc" usemap="<?php echo $m?>">
                                        <label for="allread_<?php echo $m?>"><strong><?php echo display('can_read') ?></strong></label>
                                    </div></th>
                                <th><div class="checkbox checkbox-success text-center">
                                        <input type="checkbox" class="allcheck" name="alledit" value="1" id="alledit_<?php echo $m?>" title="Sửa" usemap="<?php echo $m?>">
                                        <label for="alledit_<?php echo $m?>"><strong><?php echo display('can_edit') ?></strong></label>
                                    </div></th>
                                <th><div class="checkbox checkbox-success text-center">
                                        <input type="checkbox" class="allcheck" name="alldelete" value="1" id="alldelete_<?php echo $m?>" title="Xoá" usemap="<?php echo $m?>">
