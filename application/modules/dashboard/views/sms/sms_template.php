                            ...
                            <div class="form-body">
                               <input type="hidden" name="id" id="id" value=""/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <?php echo form_dropdown('type', array('' => 'Chọn','Cancel' => 'Cancel', 'Neworder' =>'New Order',  'CompleteOrder' => 'Complete Order',  'Processing' => 'Processing'), null, array('class'=>'form-control dont-select-me', 'id'=>'type', 'required'=>'required')) ?> 
                                        </div>
                                    </div>
