                            ...
                            <?php foreach ($couponlist as $token) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <input name="url" type="hidden" id="url_<?php echo $token->tokenid; ?>" value="<?php echo base_url("dashboard/couponlist/updateintfrm") ?>" />
                                        <a onclick="editinfo('<?php echo $token->tokenid; ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Cập nhật"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                         <?php endif; 
										 if($this->permission->method('setting','delete')->access()): ?>
                                        <a href="<?php echo base_url("dashboard/couponlist/delete/$token->tokenid") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Xoá "><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
                                         <?php endif; ?>
                                    </td>
