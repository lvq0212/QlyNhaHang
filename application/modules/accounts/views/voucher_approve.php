                    ...
                    <table class="datatable table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="<?php echo base_url("accounts/accounts/isactive/$approve->VNo/active") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="right" title="Vô hiệu"><?php echo display('approved')?></a>
