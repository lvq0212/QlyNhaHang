				...
				echo form_open_multipart("itemmanage/menu_addons/create") ?>
                   ...
                   <?php  echo form_hidden('id',$this->session->userdata('id')); ?>
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <label for="firstname" class="col-sm-4 col-form-label">Giá *</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="status"  class="form-control">
                                ...
                                <option value="1" <?php if(!empty($addonsinfo)){if($addonsinfo->is_active==1){echo "Selected";}} else{echo "Selected";} ?>>Hiệu lực</option>
                                <option value="0" <?php if(!empty($addonsinfo)){if($addonsinfo->is_active==0){echo "Selected";}} ?>>Vô hiệu</option>
                              </select>
                        </div>
                    </div>
