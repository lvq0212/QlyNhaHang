                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                             <select name="status"  class="form-control">
                                ...
                                <option value="1" <?php if(!empty($categoryinfo)){if($categoryinfo->CategoryIsActive==1){echo "Selected";}} else{echo "Selected";} ?>>Hiệu lực</option>
                                <option value="0" <?php if(!empty($categoryinfo)){if($categoryinfo->CategoryIsActive==0){echo "Selected";}} ?>>Vô hiệu</option>
                              </select>
                        </div>
                    </div>
