        ...
        <div class="panel panel-bd">
            <div class="panel-heading">
                <div class="panel-title box-header itemmanage_box_header" >
                    ...
                    <div class="col-md-2"><input type="text" name="item_list" class="form-control" placeholder="Tìm kiếm" id="item_list"  />
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("itemmanage/item_food/addgroupfood") ?>
                    ...
                    <div class="form-group row">
                        <label for="category" class="col-sm-4 col-form-label">Thể loại</label>
                        <div class="col-sm-8">
                        <select name="CategoryID" class="form-control" required="">
                            <option value="" selected="selected">Tên thể loại</option> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="itemnotes" class="form-control" type="text" placeholder="Thêm tiêu đề" id="itemnotes"  value="<?php echo (!empty($productinfo->itemnotes)?$productinfo->itemnotes:null) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="itemnotes" class="col-sm-4 col-form-label">Mô tả </label>
                        <div class="col-sm-8">
                            <input name="descrip" class="form-control" type="text" placeholder="Thêm mô tả" id="descrip"  value="<?php echo (!empty($productinfo->descrip)?$productinfo->descrip:null) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
...
<input type="hidden" name="old_image" value="<?php echo (!empty($productinfo->ProductImage)?$productinfo->ProductImage:null) ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select name="status"  class="form-control">
                                ...
                                <option value="1" <?php  if(!empty($productinfo)){if($productinfo->ProductsIsActive==1){echo "Selected";}} else{echo "Selected";} ?>>Hiệu lực</option>
                    ...
                    <div class="col-lg-4">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="price" class="form-control" type="text" placeholder="Giá" id="price"  value="<?php echo (!empty($productinfo->price)?$productinfo->price:null) ?>">
                        </div>
                    </div>
                    </div>
                <?php echo form_close() ?>
