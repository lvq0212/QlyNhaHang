            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("itemmanage/item_food/create") ?>
                    ...
                    <div class="form-group row">
                        <label for="category" class="col-sm-4 col-form-label">Loại món</label>
                        <div class="col-sm-8">
                        <select name="CategoryID" class="form-control" required="">
                            <option value="" selected="selected">Tên loại món</option> 
                    ...
                    <div class="form-group row">
                        <label for="foodname" class="col-sm-4 col-form-label">Tên món* </label>
                        <div class="col-sm-8">
                            <input name="foodname" class="form-control" type="text" placeholder="Tên món" id="foodname"  value="<?php echo (!empty($productinfo->ProductName)?$productinfo->ProductName:null) ?>">
                        </div>
                    </div>
					<div class="form-group row">
                        <label for="component" class="col-sm-4 col-form-label">Thành phần </label>
                        <div class="col-sm-8">
                            <input name="component" class="form-control" data-role="tagsinput" type="text" placeholder="Thành phần" id="category_subtitle"  value="<?php echo (!empty($productinfo->component)?$productinfo->component:null) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="itemnotes" class="col-sm-4 col-form-label">Tiêu đề </label>
                        <div class="col-sm-8">
                            <input name="itemnotes" class="form-control" type="text" placeholder="Tiêu đề" id="itemnotes"  value="<?php echo (!empty($productinfo->itemnotes)?$productinfo->itemnotes:null) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="itemnotes" class="col-sm-4 col-form-label">Mô tả </label>
                        <div class="col-sm-8">
                            <input name="descrip" class="form-control" type="text" placeholder="Mô tả" id="descrip"  value="<?php echo (!empty($productinfo->descrip)?$productinfo->descrip:null) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="firstname" class="col-sm-4 col-form-label">Ảnh </label>
                        <div class="col-sm-8">
...
<input type="hidden" name="old_image" value="<?php echo (!empty($productinfo->ProductImage)?$productinfo->ProductImage:null) ?>">
                    ...
                    <div class="col-lg-6">
                    <div class="form-group row">
                        <label for="vat" class="col-sm-5 col-form-label">Thuế VAT <a class="cattooltips" data-toggle="tooltip" data-placement="top" title="Vat Are always Caltulate percent like: 5 means 5%;"><i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label for="offerate" class="col-sm-5 col-form-label">% Ưu đãi <a class="cattooltips" data-toggle="tooltip" data-placement="top" title="Offer Rate Must be a number. It a Percentange Like: if 5% then put 5"><i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label for="offerstartdate" class="col-sm-5 col-form-label">Ngày bắt đầu </label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label for="offerendate" class="col-sm-5 col-form-label">Ngày kết thúc </label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        <label for="lastname" class="col-sm-5 col-form-label">Trạng thái</label>
                        <div class="col-sm-7">
                            <select name="status"  class="form-control">
                                <option value=""  selected="selected">Chọn</option>
                                <option value="1" <?php  if(!empty($productinfo)){if($productinfo->ProductsIsActive==1){echo "Selected";}} else{echo "Đã chọn";} ?>>Hiệu lực</option>
                                <option value="0" <?php if($productinfo->ProductsIsActive==0){echo "Selected";} ?>>Vô hiệu</option>
                              </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group text-right">
                        <button type="reset" class="btn btn-primary w-md m-b-5">Làm trống</button>
                        <button type="submit" class="btn btn-success w-md m-b-5">Lưu</button>
                    </div>
                    </div>
                <?php echo form_close() ?>
