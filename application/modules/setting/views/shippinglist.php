                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                   ...
                                   <td class="center">
                                    ...
                                    <input name="url" type="hidden" id="url_<?php echo $shipping->ship_id; ?>" value="<?php echo base_url("setting/shippingmethod/updateintfrm") ?>" />
                                        <a onclick="editinfoshiping('<?php echo $shipping->ship_id; ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                         <?php endif; 
