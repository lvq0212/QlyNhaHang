            ...
            <div class="row about_inner align-items-center wrap-reverse-md">
                <div class="col-xl-5 col-lg-6">
                    <div class="sect_title mb-4">
                        <table>
                            <tr>
                                <th><img src="<?php echo base_url('assets/img/hoatiet.png'); ?>" class="hoa-tiet"></th>
                                <th><h3 class="big_title"><?php echo $history->widget_title; ?> <span><br><?php echo $history->widget_name; ?></span></h3></th>
                                <th><img src="<?php echo base_url('assets/img/hoatiet.png'); ?>" class="hoa-tiet"></th>
                            </tr>
                        </table>
                    </div>
                    ...
                    <form class="main-reservaton-form" action="#" method="post">
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                ...
                                <input type="text" name="reservation_person" id="reservation_person" placeholder="Tổng số người" autocomplete="off">
                            </div>
                            <div class="col-lg-12 mb-4">
                                <label for="reservation_date"><i class="ti-calendar"></i></label>
                                <input type="text" name="reservation_date" id="reservation_date" placeholder="Ngày dự kiến" class="datepickerreserve" autocomplete="off">
                            </div>
                            <div class="col-lg-12 mb-4">
                                <label for="reservation_time"><i class="ti-alarm-clock"></i></label>
                                <input type="text" name="reservation_time" id="reservation_time" placeholder="Ngày dự kiến" autocomplete="off">
                            </div>
                            <div class="col-lg-12 mb-4">
                                <label for="reservation_contact"><i class="fa fa-phone"></i></label>
                                <input type="text" name="reservation_contact" id="reservation_contact" placeholder="Số điện thoại liên hệ" autocomplete="off">
                            </div>
                            <div class="col-lg-12">
