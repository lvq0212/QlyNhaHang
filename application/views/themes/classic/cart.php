                ...
                <div class="col-lg-9">
                    <div class="cart_heading">
                        <div class="shopping-cart">
                            <h5 class="cart-page-title">Giỏ hàng</h5>
...
if(!empty($this->cart->contents())){ $totalqty= count($this->cart->contents());} ;?>
					...
					if ($cart = $this->cart->contents()){
						...
						foreach ($cart as $item){
                            ...
                            <div class="cart_btn_area d-flex justify-content-between align-items-center">
                                <a href="<?php echo base_url();?>menu" class="btn-dark mt-0">Tiêp tục mua hàng</a>
                            </div>
							<div class="row">
                ...
                <div class="col-lg-3">
                <div class="coupon">
                        <h5 class="text-center mb-4">Mã giảm giá</h5>
                        <div class="">
                        	<?php echo form_open('checkcoupon','method="post"')?>
                            <input type="text" class="form-control" id="couponcode" name="couponcode" placeholder="Điền mã.." required>
                            <input name="coupon" class="btn simple_btn mt-2" type="submit" value="Áp dụng" />
                            </form>
                        </div>
                    </div>
                <?php if(!empty($this->cart->contents())){
                    ...
                    <div class="totals_area mt-4">
                        ...
                        <div class="totals">
                            ...
                            <button onclick="gotocheckout()" class="checkout">Thanh toán</button>
                        </div>
                    </div>
                    <?php } ?>
